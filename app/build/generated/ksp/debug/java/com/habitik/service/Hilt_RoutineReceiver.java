...
public abstract class Hilt_RoutineReceiver extends BroadcastReceiver {
  ...
  protected void inject(Context context) {
    if (!injected) {
      synchronized (injectedLock) {
        if (!injected) {
          ((RoutineReceiver_GeneratedInjector) BroadcastReceiverComponentManager.generatedComponent(context)).injectRoutineReceiver(UnsafeCasts.<RoutineReceiver>unsafeCast(this));
          injected = true;
        }
      }
    }
